...
<body>
    <div class="container">
        <h1 class="mx-auto text-center" style="width: auto">This is confirmation page</h1>
        ...
        <div class="alert alert-dark my-1 mx" role="alert" style="height: 7vh">
            <div class="d-flex justify-content-between">
                <h3 class="text-left align-middle" style="width: 20vw">Total price: <c:out value="${total}" /></h3>
